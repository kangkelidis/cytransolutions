...
export default function Card({
  ...
  return (
    <div className="flex max-md:flex-col gap-4 items-center justify-around w-full min-w-min h-fit bg-gray-800 my-1 mx-6 p-2">
      <div className="flex w-full gap-2 justify-between min-h-[5rem]">
