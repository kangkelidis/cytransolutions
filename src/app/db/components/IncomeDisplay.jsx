  ...
  function ControlsBox() {
    return (
      <div className="flex flex-col p-4 gap-3">
        <button className="py-2.5 leading-5 text-white transition-colors duration-300 transform bg-slate-500 rounded-md hover:bg-purple-500 focus:outline-none focus:bg-purple-500">
          Print Report
        </button>
        <button
          className={`${selectedBtn === "month" && "bg-slate-900"} border-[0.5px] rounded-md py-1 shadow-lg hover:bg-slate-900 hover:border-slate-900 focus:bg-slate-900 focus:border-slate-900 focus:outline-none`}
          onClick={() => {
        ...
        <button
          className={`${selectedBtn === "year" && "bg-slate-900"} border-[0.5px] rounded-md py-1 shadow-lg hover:bg-slate-900 hover:border-slate-900 focus:bg-slate-900 focus:border-slate-900 focus:outline-none`}
          onClick={() => {
            setSelectedBtn("year");
            setDate({
        ...
        <button
          className={`${selectedBtn === "all" && "bg-slate-900"} border-[0.5px] rounded-md py-1 shadow-lg hover:bg-slate-900 hover:border-slate-900 focus:bg-slate-900 focus:border-slate-900 focus:outline-none`}
          onClick={() => {
            setSelectedBtn("all")
            setDate({
