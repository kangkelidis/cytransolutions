...
export default function Row({ entry, type, border, ridesInInvoice, setReload }) {
  ...
  switch (type) {
    ...
    case "invoice":
        return <InvoiceRow entry={entry} tdClass={tdClass} trClass={trClass} tdId={tdId} setReload={setReload}/>;
    case "driver":
