...
export default function RideForm() {
  ...
  const [data, setData] = React.useState({ date: Date.now() });
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
        ...
        <div>
          <label className="text-gray-700 dark:text-gray-200" htmlFor="driver">
            Driver*
          </label>
          <select
            required
        ...
        <div>
          <label className="text-gray-700 dark:text-gray-200" htmlFor="client">
            Client
          </label>
          <select
            id="client"
        ...
        <div>
          <label className="text-gray-700 dark:text-gray-200" htmlFor="credit">
            Credit
          </label>
          <input
            id="credit"
